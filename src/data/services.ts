...
export const SERVICES: Service[] = [
  {
    ...
    tagline: 'A professional small-business site, live seven days after kickoff.',
    price: '$950',
  ...
  },
  {
    id: 'it-help-desk',
    name: 'IT Help Desk',
    tagline: 'Flat-rate tech support for home offices and small teams, by 3ME Computing.',
    price: 'from $39',
  ...
  },
  {
    ...
    tagline: 'Menu site, QR menus and online ordering, from someone who has run a line.',
    price: 'from $1,250',
